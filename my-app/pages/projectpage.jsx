...
export const getStaticProps = async () => {
  ...
  const res = await fetch('https://kaedmacabanti.github.io/my_api_data1/data1.json');
...
{/*        <div>
      ...
      <div class="right-side">
        ...
        <a className='button'>DONATE TO THIS PROJECT</a>
